...
from generators import filter_by_currency, transaction_descriptions, card_number_generator # type: ignore
...
if __name__ == "__main__":
    ...
    for card_number in card_number_generator(11111, 11199):
        print(card_number)
